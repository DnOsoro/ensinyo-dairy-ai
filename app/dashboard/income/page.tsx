...
export default async function IncomePage() {
  ...
  const incomeBreakdown = incomeRecords.reduce(
    (acc, record) => {
      const category =
        ...
        {safeFarms.length === 0 && (
          <div className="mt-8 rounded-2xl bg-white p-10 text-center shadow-sm ring-1 ring-gray-200">
            ...
            <p className="mx-auto mt-2 max-w-md text-gray-600">
              Before recording income, you need to
            ...
            <section className="mt-8">
              ...
              {incomeRecords.length === 0 ? (
                ...
                <div className="rounded-2xl bg-white p-10 text-center shadow-sm ring-1 ring-gray-200">
                  ...
                  <p className="mx-auto mt-2 max-w-md text-gray-600">
                    Start recording milk sales,
                    livestock sales and other farm income.
                  </p>
